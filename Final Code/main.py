...
class OptionPricerGUI:
    ...
    def create_european_frame(self):
        ...
        self.create_input_field(frame, "Spot Price (S0):", self.euro_S0, 0, 100)
        self.create_input_field(frame, "Volatility (σ):", self.euro_sigma, 1, 0.3)
        self.create_input_field(frame, "Risk-free Rate (r):", self.euro_r, 2, 0.05)
        self.create_input_field(frame, "Repo Rate (q):", self.euro_q, 3, 0.0)
        self.create_input_field(frame, "Time to Maturity (T):", self.euro_T, 4, 3)
        self.create_input_field(frame, "Strike Price (K):", self.euro_K, 5, 100)
        
        # Option type dropdown
        tb.Label(frame, text="Option Type:", bootstyle=PRIMARY).grid(
    ...
    def create_implied_vol_frame(self):
        ...
        self.create_input_field(frame, "Spot Price (S0):", self.iv_S0, 0, 100)
        self.create_input_field(frame, "Risk-free Rate (r):", self.iv_r, 1, 0.05)
        self.create_input_field(frame, "Repo Rate (q):", self.iv_q, 2, 0.0)
        self.create_input_field(frame, "Time to Maturity (T):", self.iv_T, 3, 3)
        self.create_input_field(frame, "Strike Price (K):", self.iv_K, 4, 100)
        self.create_input_field(frame, "Option Premium:", self.iv_premium, 5, 20)
    ...
    def create_american_frame(self):
        ...
        self.create_input_field(frame, "Spot Price (S0):", self.amer_S0, 0, 100)
        self.create_input_field(frame, "Volatility (σ):", self.amer_sigma, 1, 0.3)
        self.create_input_field(frame, "Risk-free Rate (r):", self.amer_r, 2, 0.05)
        self.create_input_field(frame, "Time to Maturity (T):", self.amer_T, 3, 3)
        self.create_input_field(frame, "Strike Price (K):", self.amer_K, 4, 100)
        self.create_input_field(frame, "Number of Steps (N):", self.amer_N, 5, 100)
    ...
    def create_geometric_asian_frame(self):
        ...
        self.create_input_field(frame, "Spot Price (S0):", self.geo_asian_S0, 0, 100)
        self.create_input_field(frame, "Volatility (σ):", self.geo_asian_sigma, 1, 0.3)
        self.create_input_field(frame, "Risk-free Rate (r):", self.geo_asian_r, 2, 0.05)
        self.create_input_field(frame, "Time to Maturity (T):", self.geo_asian_T, 3, 3)
        self.create_input_field(frame, "Strike Price (K):", self.geo_asian_K, 4, 100)
        self.create_input_field(frame, "Number of Observations (n):", self.geo_asian_n, 5, 50)
    ...
    def create_arithmetic_asian_frame(self):
        ...
        self.create_input_field(frame, "Spot Price (S0):", self.ari_asian_S0, 0, 100)
        self.create_input_field(frame, "Volatility (σ):", self.ari_asian_sigma, 1, 0.3)
        self.create_input_field(frame, "Risk-free Rate (r):", self.ari_asian_r, 2, 0.05)
        self.create_input_field(frame, "Time to Maturity (T):", self.ari_asian_T, 3, 3)
        self.create_input_field(frame, "Strike Price (K):", self.ari_asian_K, 4, 100)
        self.create_input_field(frame, "Number of Observations (n):", self.ari_asian_n, 5, 50)
        self.create_input_field(frame, "Number of Paths (m):", self.ari_asian_m, 6, 100000)
        
        # Control variate dropdown
        tb.Label(frame, text="Control Variate:", bootstyle=PRIMARY).grid(
        ...
        cv_menu.grid(row=7, column=1, padx=5, pady=5, sticky=tk.W)
        self.ari_asian_cv.set("Geometric Asian")
    ...
    def create_geometric_basket_frame(self):
        ...
        self.create_input_field(frame, "Spot Price Asset 1 (S1):", self.geo_basket_S1, 0, 100)
        self.create_input_field(frame, "Spot Price Asset 2 (S2):", self.geo_basket_S2, 1, 100)
        self.create_input_field(frame, "Volatility Asset 1 (σ1):", self.geo_basket_sigma1, 2, 0.3)
        self.create_input_field(frame, "Volatility Asset 2 (σ2):", self.geo_basket_sigma2, 3, 0.3)
        self.create_input_field(frame, "Risk-free Rate (r):", self.geo_basket_r, 4, 0.05)
        self.create_input_field(frame, "Time to Maturity (T):", self.geo_basket_T, 5, 3)
        self.create_input_field(frame, "Strike Price (K):", self.geo_basket_K, 6, 100)
        self.create_input_field(frame, "Correlation (ρ):", self.geo_basket_rho, 7, 0.5)
    ...
    def create_arithmetic_basket_frame(self):
        ...
        self.create_input_field(frame, "Spot Price Asset 1 (S1):", self.ari_basket_S1, 0, 100)
        self.create_input_field(frame, "Spot Price Asset 2 (S2):", self.ari_basket_S2, 1, 100)
        self.create_input_field(frame, "Volatility Asset 1 (σ1):", self.ari_basket_sigma1, 2, 0.3)
        self.create_input_field(frame, "Volatility Asset 2 (σ2):", self.ari_basket_sigma2, 3, 0.3)
        self.create_input_field(frame, "Risk-free Rate (r):", self.ari_basket_r, 4, 0.05)
        self.create_input_field(frame, "Time to Maturity (T):", self.ari_basket_T, 5, 3)
        self.create_input_field(frame, "Strike Price (K):", self.ari_basket_K, 6, 100)
        self.create_input_field(frame, "Correlation (ρ):", self.ari_basket_rho, 7, 0.5)
        self.create_input_field(frame, "Number of Paths (m):", self.ari_basket_m, 8, 100000)
        ...
        self.ari_basket_cv.set("Geometric Basket")
    ...
    def create_kiko_frame(self):
        ...
        self.create_input_field(frame, "Spot Price (S0):", self.kiko_S0, 0, 100)
        self.create_input_field(frame, "Volatility (σ):", self.kiko_sigma, 1, 0.3)
        self.create_input_field(frame, "Risk-free Rate (r):", self.kiko_r, 2, 0.05)
        self.create_input_field(frame, "Time to Maturity (T):", self.kiko_T, 3, 3)
        self.create_input_field(frame, "Strike Price (K):", self.kiko_K, 4, 100)
        self.create_input_field(frame, "Lower Barrier (L):", self.kiko_L, 5, 80)
        self.create_input_field(frame, "Upper Barrier (U):", self.kiko_U, 6, 120)
        self.create_input_field(frame, "Number of Observations (n):", self.kiko_n, 7, 50)
        self.create_input_field(frame, "Rebate (R):", self.kiko_R, 8, 10)
    ...
    def empty_callback(self):
        """Placeholder callback function for buttons"""
        self.output_text.insert(tk.END, "Calculation function not implemented (interface only)\n")
        self.status.config(text="Calculation function not implemented")
